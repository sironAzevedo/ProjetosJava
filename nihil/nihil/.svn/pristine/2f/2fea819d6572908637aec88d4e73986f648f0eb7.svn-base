...
public enum TipoTarget {
     ...
     */
    private TipoTarget(final String newId, final String descricao) {
        this.id = newId;
     ...
     */
    public static TipoTarget from(final String valor) {
        if (valor == null) {
            throw new NullPointerException();
        }

        for (TipoTarget e : TipoTarget.values()) {
        ...
        msg.append("Cannot parse into an element of TipoTarget: '");
        msg.append(valor);
        msg.append("'");
