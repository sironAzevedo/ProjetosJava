...
public class ConsultaAgenciamentosParaRelatorioMovimentacaoEmbacacao extends BusinessQuery<Agenciamento> {

    public ConsultaAgenciamentosParaRelatorioMovimentacaoEmbacacao(Agencia agencia, List<StatusEmbarcacao> listaStatus, Porto porto) {
