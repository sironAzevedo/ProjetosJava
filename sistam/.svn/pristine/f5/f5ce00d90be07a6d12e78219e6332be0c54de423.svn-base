...
public class CadastroAgenciaOrgaoDespacholDialog extends SDialog {
    private CadastroAgenciaOrgaoDespachoModel model;
    
    public CadastroAgenciaOrgaoDespacholDialog(java.awt.Frame parent, Agencia agencia) {
        super(parent, true);
        this.model = new CadastroAgenciaOrgaoDespachoModel(agencia);
        initComponents();
        setLocationRelativeTo(parent);
    }

    public CadastroAgenciaOrgaoDespachoModel getModel() {
        return model;
    }

    public void novo(){
        AgenciaOrgaoDespacho agenciaOrgaoDespacho = new AgenciaOrgaoDespacho();
        agenciaOrgaoDespacho.setAgencia(model.getAgencia());
        DetalheAgenciaOrgaoDespachoDialog dialog = new DetalheAgenciaOrgaoDespachoDialog(SistamApp.getSistamApp().getMainFrame(), agenciaOrgaoDespacho);
    ...
    public void editar(){
        DetalheAgenciaOrgaoDespachoDialog dialog = new DetalheAgenciaOrgaoDespachoDialog(SistamApp.getSistamApp().getMainFrame(), model.getOrgaoSelecionado());
        dialog.setVisible(true);
        model.consultar(model.getAgencia());
    }
    ...
    private void initComponents() {
        ...
        actionEditar.setToolTipText("Edita o órgão selecionado");

        Binding binding = Bindings.createAutoBinding(UpdateStrategy.READ_WRITE, this, ELProperty.create("${not empty model.contatoSelecionado}"), actionEditar, BeanProperty.create("enabled"));
        ...
        actionNovo.setToolTipText("Inclui novo órgão");

        setDefaultCloseOperation(WindowConstants.DISPOSE_ON_CLOSE);
        setTitle("Órgão Despacho da Agência");
        ...
        sPanel1.setBorder(BorderFactory.createTitledBorder("Lista de Órgãos Despacho"));
        ...
        ELProperty eLProperty = ELProperty.create("${model.orgaos}");
        ...
        jTableBinding.bind();binding = Bindings.createAutoBinding(UpdateStrategy.READ_WRITE, this, ELProperty.create("${model.orgaoSelecionado}"), sTable1, BeanProperty.create("selectedElement"));
        bindingGroup.addBinding(binding);
